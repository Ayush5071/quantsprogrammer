export default function Loading() {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[#0a0a0f] z-50">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-indigo-600/15 rounded-full blur-3xl animate-pulse delay-500" />
      ...
      <div className="relative flex flex-col items-center gap-6">
        ...
        <div className="relative w-20 h-20">
          ...
          {/* Inner Ring */}
          <div className="absolute inset-4 rounded-full border-2 border-transparent border-t-blue-400 animate-spin" style={{ animationDuration: '0.6s' }} />
          {/* Center Dot */}
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-3 h-3 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 animate-pulse" />
          </div>
        </div>
        
        {/* Text */}
        <div className="flex flex-col items-center gap-1">
          <p className="text-sm font-medium text-white tracking-wide">Loading</p>
