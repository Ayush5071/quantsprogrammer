        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8 sm:mb-12">
              ...
              {/* Buy Me a Coffee Button - Hidden on mobile, simplified animation */}
              <motion.a
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="hidden sm:flex w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-bold rounded-xl shadow-2xl hover:shadow-orange-500/25 transition-all duration-200 text-lg items-center justify-center gap-3 hover:from-yellow-400 hover:to-orange-400"
              >
